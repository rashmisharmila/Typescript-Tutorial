...
let location1_Lan_input_element=document.getElementById('lat1')as HTMLInputElement;
let location1_Lon_input_element=document.getElementById('lon1')as HTMLInputElement;
let location2_Lan_input_element=document.getElementById('lat2')as HTMLInputElement;
...
btn_element.addEventListener('click',()=>{
    let location1_lat=location1_Lan_input_element.value;
    let location1_lon=location1_Lon_input_element.value;
    let location2_lat=location2_Lan_input_element.value;
